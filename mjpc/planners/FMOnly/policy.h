...
#ifndef MJPC_PLANNERS_FMONLY_POLICY_H_
#define MJPC_PLANNERS_FMONLY_POLICY_H_
...
class FMOnlyPolicy : public Policy {
 public:
  // constructor
  FMOnlyPolicy() = default;

  // destructor
  ~FMOnlyPolicy() override = default;
  ...
  // copy policy
  void CopyFrom(const FMOnlyPolicy& policy, int horizon);
...
#endif  // MJPC_PLANNERS_FMONLY_POLICY_H_
