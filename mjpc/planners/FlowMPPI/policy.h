...
#ifndef MJPC_PLANNERS_FLOWMPPI_POLICY_H_
#define MJPC_PLANNERS_FLOWMPPI_POLICY_H_
...
class FlowMPPIPolicy : public Policy {
 public:
  // constructor
  FlowMPPIPolicy() = default;

  // destructor
  ~FlowMPPIPolicy() override = default;
  ...
  // copy policy
  void CopyFrom(const FlowMPPIPolicy& policy, int horizon);
...
#endif  // MJPC_PLANNERS_FLOWMPPI_POLICY_H_
