...
#ifndef MJPC_PLANNERS_MPOPI_POLICY_H_
#define MJPC_PLANNERS_MPOPI_POLICY_H_
...
class MPOPIPolicy : public Policy {
 public:
  // constructor
  MPOPIPolicy() = default;

  // destructor
  ~MPOPIPolicy() override = default;
  ...
  // copy policy
  void CopyFrom(const MPOPIPolicy& policy, int horizon);
...
#endif  // MJPC_PLANNERS_MPOPI_POLICY_H_
