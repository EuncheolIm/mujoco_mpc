...
#ifndef MJPC_PLANNERS_MPPI_POLICY_H_
#define MJPC_PLANNERS_MPPI_POLICY_H_
...
class MPPIPolicy : public Policy {
 public:
  // constructor
  MPPIPolicy() = default;

  // destructor
  ~MPPIPolicy() override = default;
  ...
  // copy policy
  void CopyFrom(const MPPIPolicy& policy, int horizon);
...
#endif  // MJPC_PLANNERS_MPPI_POLICY_H_
