...
#ifndef MJPC_MJPC_TASKS_FR3HGRIPPERCOCARRY_FR3_H_
#define MJPC_MJPC_TASKS_FR3HGRIPPERCOCARRY_FR3_H_
...
namespace mjpc {
class FR3HGripperCoCarry : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const FR3HGripperCoCarry* task)
        : mjpc::BaseResidualFn(task) {}
    void Residual(const mjModel* model, const mjData* data,
                  double* residual) const override;
  };
  FR3HGripperCoCarry() : residual_(this) {}
...
#endif  // MJPC_MJPC_TASKS_FR3HGRIPPERCOCARRY_FR3_H_
